...
import com.cloudshiba.jdbcplay.dao.StatementCrudDAO;
...
@Slf4j
@Service
public class StatementCrudService {
    private final StatementCrudDAO dao;

    public StatementCrudService(final StatementCrudDAO dao) {
        this.dao = dao;
    }
