...
import com.cloudshiba.jdbcplay.dao.PreparedStatementCrudDAO;
...
@Slf4j
@Service
public class PreparedStatementCrudService {
    private final PreparedStatementCrudDAO dao;

    public PreparedStatementCrudService(final PreparedStatementCrudDAO dao) {
        this.dao = dao;
    }
